CONFIG_DESCRIPTIONS = [
    {name: 'do_show_facebook_like', description: 'Facebook Like count'}
    {name: 'do_show_facebook_share', description: 'Facebook Share count'}
    {name: 'do_show_twitter_tweet', description: 'Twitter Tweet count'},
    {name: 'do_show_hatena_bookmark', description: 'Hatena Bookmark count'},
    {name: 'do_show_automatically', description: 'show automatically on load'},
    {name: 'panel_position', description: 'panel position', candidates: ['outer right', 'outer bottom', 'inner left']},
]

BINDING_DESCRIPTIONS = [
    {name: 'toggle_popularities', description: 'show popularities'},
]
