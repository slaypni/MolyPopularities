...
INITIAL_SETTINGS =
    do_show_facebook_like: true
    do_show_facebook_share: false
    do_show_twitter_tweet: true
    do_show_hatena_bookmark: false
    do_show_automatically: false
    panel_position: 'inner left'
    bindings:
        toggle_popularities: []
